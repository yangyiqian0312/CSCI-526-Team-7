...
public class MainMenuController : MonoBehaviour {
    ...
    public void openContinue_Load()
    {
        ...
        // //play click sfx
        // playClickSound();
        GameData.date  = PlayerPrefs.GetInt("playerDate", 1);
        GameData.tips = PlayerPrefs.GetInt("tipsEarned", 0);
        Debug.Log("current date is day "+ GameData.date);
        Debug.Log("current tips earned is "+ GameData.tips);
